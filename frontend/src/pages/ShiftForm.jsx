...
export function ShiftForm({ shiftId, onNavigate }) {
  ...
  async function submit(event) {
    ...
    const payload = {
      role: fields.role.trim(), description: fields.description.trim() || null, date: fields.date, start_time: toApiTime(fields.start_time), end_time: toApiTime(fields.end_time),
